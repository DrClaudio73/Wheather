...
def WatchDogFun():
        global kkkWD,WatchDogPrev
        while True:
            #print("Hello from thread WatchDog,WatchDogPev,kkkWD:",WatchDog,WatchDogPrev,kkkWD)
            if WatchDogPrev==WatchDog:
                kkkWD=kkkWD+1
            else:
                kkkWD=0

            WatchDogPrev=WatchDog

            if kkkWD>mainAppConstants.MAX_KKK_WD:
                machine.reset()
            #print("kkkWD,WatchDogPrev,WatchDog,MAX_KKK_WD:",kkkWD,WatchDogPrev,WatchDog,mainAppConstants.MAX_KKK_WD)
            time.sleep(mainAppConstants.THREAD_INTERVAL)
